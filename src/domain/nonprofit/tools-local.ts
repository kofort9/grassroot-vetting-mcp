...
//
// Replaces ProPublica-based tools with BMF + GivingTuesday XML data.
...
interface LocalProfileResolution {
  ...
  filingsAdapter: ProPublica990Filing[] | undefined;
}
...
/**
 * Build a ProPublica990Filing[] adapter from all available XML extracts
